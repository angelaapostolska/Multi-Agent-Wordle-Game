...
class AgentStats:
    ...
    across languages. Ported from master; the reward system underneath it
    (task_reward, run_episode's proposal logic) is unchanged from this
    branch's own info-gain-reward + epsilon-greedy setup.
    """
